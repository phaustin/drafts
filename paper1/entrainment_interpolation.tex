...
are two to five times as large as values calculated via bulk tracers.
Correcting the entrainment and detrainment values to account for the effect of
the moist cloud shell reduces this over-estimate to a factor of two.  However,
the correlation of values calculated via the two methods is nearly unity,
suggesting our method captures the dynamics of entrainment and detrainment well.
}
%
\begin{document}
%
