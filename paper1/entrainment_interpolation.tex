...
refer to as "Romps entrainment" to represent the true entrainment, when 
averaged over a suitably long period, as it uses a minimal set of assumptions
to perform its calculations.  We therefore use the Romps entrainment scheme in
this section to evaluate the accuracy of our tetrahedral interpolation.
...
redefines the times at which entrainment and detrianment takes place.  

* TK more comparison with final result *
