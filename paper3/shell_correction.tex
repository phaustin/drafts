...
using trace budgets.  The  Siebesma trace budget calculations and 
estimates of  transformed direct entrainment and detrainment aslo
differ in their treatment of vertical advection.
in the tracer budget calculation 
and (\ref{eq:siebesma_detrainment})).  The Siebesma tracer budget calculated
using (\ref{eq:siebesma_entrainment}) accounts for the
